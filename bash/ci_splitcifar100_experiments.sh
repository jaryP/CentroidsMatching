...
;;
cml)
  python main.py +scenario=class_incremental_cifar100 +model=resnet20 +training=cifar100 training.epochs=40 +method=cml_01 optimizer=sgd  training.device="$DEVICE" hydra.run.dir='./results/ci_cifar100/resnet20/cml/cml_01'
#  python main.py +scenario=class_incremental_cifar100 +model=resnet20 +training=cifar100 training.epochs=40 +method=cml_05 optimizer=sgd  training.device="$DEVICE" hydra.run.dir='./results/ci_cifar100/resnet20/cml/cml_05'
...
#  python main.py +scenario=class_incremental_cifar100 +model=resnet20 +training=cifar100 training.epochs=40 +method=cml_10 optimizer=sgd  training.device="$DEVICE" hydra.run.dir='./results/ci_cifar100/resnet20/cml/cml_10'
;;
naive)
