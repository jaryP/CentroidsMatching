...
#  python main.py +scenario=task_incremental_tinyimagenet +model=resnet20 +training=tinyimagenet training.epochs=20 +method=cml_1 optimizer=sgd  training.device="$DEVICE" hydra.run.dir='./results/ti_tinyimagenet/resnet20/cml/cml_1'
...
#  python main.py +scenario=task_incremental_tinyimagenet +model=resnet20 +training=tinyimagenet training.epochs=20 +method=cml_10 optimizer=sgd  training.device="$DEVICE" hydra.run.dir='./results/ti_tinyimagenet/resnet20/cml/cml_10'
;;
naive)
