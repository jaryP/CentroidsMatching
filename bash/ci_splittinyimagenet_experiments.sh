...
case $METHOD in
gem)
#  python main.py experiment=base2 +scenario=class_incremental_tinyimagenet +model=resnet20 +training=tinyimagenet +method=gem_200 optimizer=sgd  training.device="$DEVICE" hydra.run.dir='./results/ci_tinyimagenet/resnet20/gem/gem_200'
#  python main.py experiment=base2 +scenario=class_incremental_tinyimagenet +model=resnet20 +training=tinyimagenet +method=gem_500 optimizer=sgd  training.device="$DEVICE" hydra.run.dir='./results/ci_tinyimagenet/resnet20/gem/gem_500'
...
;;
er)
#  python main.py experiment=base2 +scenario=class_incremental_tinyimagenet +model=resnet20 +training=tinyimagenet +method=er_200 optimizer=sgd  training.device="$DEVICE" hydra.run.dir='./results/ci_tinyimagenet/resnet20/er/er_200'
#  python main.py experiment=base2 +scenario=class_incremental_tinyimagenet +model=resnet20 +training=tinyimagenet +method=er_200_10 optimizer=sgd  training.device="$DEVICE" hydra.run.dir='./results/ci_tinyimagenet/resnet20/er/er_200_10'
#  python main.py experiment=base2 +scenario=class_incremental_tinyimagenet +model=resnet20 +training=tinyimagenet +method=er_500_1 optimizer=sgd  training.device="$DEVICE" hydra.run.dir='./results/ci_tinyimagenet/resnet20/er/er_500'
#  python main.py experiment=base2 +scenario=class_incremental_tinyimagenet +model=resnet20 +training=tinyimagenet +method=er_500_10 optimizer=sgd  training.device="$DEVICE" hydra.run.dir='./results/ci_tinyimagenet/resnet20/er/er_500_10'
;;
cml)
#  python main.py experiment=base2 +scenario=class_incremental_tinyimagenet +model=resnet20 +training=tinyimagenet training.epochs=20 +method=cml_05 optimizer=sgd  training.device="$DEVICE" hydra.run.dir='./results/ci_tinyimagenet/resnet20/cml/cml_05'
#  python main.py experiment=base2 +scenario=class_incremental_tinyimagenet +model=resnet20 +training=tinyimagenet training.epochs=20 +method=cml_1 optimizer=sgd  training.device="$DEVICE" hydra.run.dir='./results/ci_tinyimagenet/resnet20/cml/cml_1'
...
#  python main.py experiment=base2 +scenario=class_incremental_tinyimagenet +model=resnet20 +training=tinyimagenet training.epochs=20 +method=cml_10 optimizer=sgd  training.device="$DEVICE" hydra.run.dir='./results/ci_tinyimagenet/resnet20/cml/cml_10'
;;
naive)
